...
(* OASIS_START *)
(* DO NOT EDIT (digest: fdf57cf6173a45b07eb487d373374792) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Protocole_jeu"; "Requetes_jeu"];
                      lib_pack = false;
                      lib_internal_modules = ["Jeu_jeu"; "Async_jeu"];
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Protocole_mgmt"; "Requetes_mgmt"];
                      lib_pack = false;
                      lib_internal_modules = ["Async_mgmt"];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "serveur_jeu.ml"});
               Executable
                 ({
                     cs_name = "serveur_mgmt";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "serveur_mgmt.ml"})
            ];
          plugins =
            [(`Extra, "META", Some "0.4"); (`Extra, "StdFiles", Some "0.4")];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\152\231\022\003xl(\003He\238M\\=\226\200";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
